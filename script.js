...
const certifications = [
  {
    ...
    date: "2024",
    description: "Comprehensive course covering HTML5, CSS3, JavaScript, React, and responsive web design principles with hands-on projects.",
  ...
  },
  {
    ...
    issuer: "AWS Learning",
    date: "2024",
    description: "Introduction to AWS services including EC2, S3, RDS, and cloud architecture fundamentals for deploying web applications.",
  ...
  },
  {
    ...
    date: "2024",
    description: "Specialized training in creating responsive, mobile-first web applications with modern CSS frameworks and best practices.",
    skills: ["Responsive Design", "CSS", "Mobile Development", "UI/UX"],
